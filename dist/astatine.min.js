...
f){b[g]=[];f=0;for(e=c.selectedOptions.length;f<e;f++)b[g].push(c.selectedOptions[f].value);b[g]=b[g].join(", ")}else b[g]=e}return b}function p(a,b){window.addEventListener("DOMContentLoaded",function(){var d="string"===typeof a?document.querySelector(a):a,c=document.createElement("div");c.classList.add("spinner");d.appendChild(c);d.addEventListener("submit",function(a){a.preventDefault();b(d,d.querySelector("[type=submit]"),c)})})}function l(a){if(!a)throw Error("Astatine.ajax: requires options");
if(!a.action)throw Error("Astatine.ajax: requires options.action");if(!a.method)throw Error("Astatine.ajax: requires options.method");if(!a.success)throw Error("Astatine.ajax: requires options.success");if(!a.error)throw Error("Astatine.ajax: requires options.error");a.headers||(a.headers={});if(a.data)if("GET"===a.method)a.action=a.action+"?"+k(a.data),a.data=null;else{switch(a.requestType){case "script":a.contentType=c.script;break;case "json":a.contentType=c.json;break;case "xml":a.contentType=
c.xml;break;case "html":a.contentType=c.html;break;case "text":a.contentType=c.text;break;default:a.contentType=c.urlencoded}switch(a.responseType){case "script":a.accept=c.script;break;case "json":a.accept=c.json;break;case "xml":a.accept=c.xml;break;case "html":a.accept=c.html;break;case "text":a.accept=c.text}a.contentType===c.json&&(a.data=JSON.stringify(a.data));a.contentType===c.urlencoded&&(a.data=k(a.data))}var b=new XMLHttpRequest;b.open(a.method.toUpperCase(),a.action,!0,a.username,a.password);
a.mimeType&&b.overrideMimeType(a.mimeType);a.withCredentials&&(b.withCredentials=a.withCredentials);a.accept&&(a.headers.Accept=a.accept);a.contentType&&(a.headers["Content-Type"]=a.contentType);if(a.headers)for(var d in a.headers)b.setRequestHeader(d,a.headers[d]);b.onreadystatechange=function(){if(4===b.readyState)return 200<=b.status&&400>b.status?a.success(b):a.error(b)};b.send(a.data)}function e(a){var b=document.head,d=b.querySelector("[title=Astatine]"),c="\n\t.spinner {\n\t\tmargin: auto;\n\t\tdisplay: none;\n\t\twidth: "+
